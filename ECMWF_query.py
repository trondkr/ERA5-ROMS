	...
	def get_parameter_metadata(self, parameter):
		return {'2m_temperature': {'parameter_id': '167.128',
				...
				'Total_precipitation': {'parameter_id': '228.128',
										...
										'units': 'm'},
				'Mean_surface_net_short-wave_radiation_flux': {'parameter_id': '37.235',
															   'short_name': 'msnswrf',
															   'roms_name': 'swrad',
															   'name': 'Mean surface net short-wave radiation flux',
															   'units': 'W m-2'},
				'Mean_surface_net_long-wave_radiation_flux': {'parameter_id': '38.235',
															  'short_name': 'msnlwrf',
															  'roms_name': 'lwrad',
															  'name': 'Mean surface net long-wave radiation flux',
															  'units': 'W m-2',
															  'time_name': 'swrad_time'},
				'Mean_surface_downward_long-wave_radiation_flux': {'parameter_id': '36.235',
																   'short_name': 'msdwlwrf',
